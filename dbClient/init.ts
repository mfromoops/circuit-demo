...
await db.run('CREATE TABLE IF NOT EXISTS address_book (id INTEGER PRIMARY KEY, user_id INTEGER, addressLineOne TEXT, addressLineTwo TEXT, FOREIGN KEY(user_id) REFERENCES users(id))');
